      ...
      <div className="max-w-[1240px] mx-auto px-6 pt-16 pb-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
            ...
            >
              <img
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuB1ayqEfM9dyOZDRTFxOdh6A7g0yc46xzpTcotAIAyGaacuIlT0Bqgfa65S64ZQjyBvgbvDvOna80nQRTZZrCntFo6d9ICP-e9lEcWpIJjU_muK_F_TJgzU0b2BJVcEZtBQDaZ10DOBDacOrWR2F_H9CbSw4IetTf_aEIWoNSqABofGom1ymSCvsJHyJ1rZSXQG4AciMpr-DPOCWOahB2WNFJ_RitaS5F_zAkF_Xo_zMpjbaJCEXkcWz7JXCBuDH6Tx_9E"
                alt="Logo"
        ...
        {/* Bottom copyright */}
        <div className="border-t border-white/15 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-[#F4EBD0]/70">
          <p>© 2026 MẢNH GHÉP HỒN VIỆT. BẢO TỒN VÀ LAN TỎA GIÁ TRỊ VĂN HÓA DÂN TỘC.</p>
