        ...
        >
          ...
          >
            ...
            <div className="flex flex-col justify-center" style={{ whiteSpace: 'nowrap' }}>
              <span
                className="font-serif text-base sm:text-lg xl:text-xl font-black text-[#7A1C1C] tracking-tight uppercase leading-tight group-hover:text-[#9E2A2B] transition-colors"
