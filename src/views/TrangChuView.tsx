      ...
      >
        ...
        >
          <div className="w-full max-w-xl">
            ...
            <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-[#5B0E0E] uppercase mb-5 leading-tight drop-shadow-[0_1px_3px_rgba(255,255,255,0.9)]">
              MẢNH GHÉP
              <br />
              HỒN VIỆT
            </h1>
